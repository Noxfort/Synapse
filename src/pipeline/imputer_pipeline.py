...
#
# File: src/pipeline/imputer_pipeline.py
...
class ImputerPipeline:
    ...
    Encapsulates PIDeepONet chunking, continuous operator evaluation, and Z-Score signal restoration.
    """

    def __init__(
        self,
        model: Optional[PIDeepONet] = None,
        feature_dim: int = 4,
        seq_len: int = 24,
        patch_len: int = 8,
        stride: int = 4,

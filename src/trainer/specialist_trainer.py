...
#
# File: src/trainer/specialist_trainer.py
...
class SpecialistTrainer(ISpecialistTrainer):
    """
    ...
    def __init__(
        ...
        self.scaler = GradScaler(device=target_device.type if target_device.type in ('cuda', 'cpu') else 'cpu', enabled=(target_device.type == 'cuda'))
